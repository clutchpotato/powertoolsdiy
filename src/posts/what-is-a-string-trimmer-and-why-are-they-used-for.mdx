...
seoDescription: What is a string trimmer? Why are these used for? Here is a
  complete guide on how to properly use a string trimmer without doing damage
  to....
featuredimage: /img/what-is-a-string-trimmer-and-why-are-they-used-for.webp
